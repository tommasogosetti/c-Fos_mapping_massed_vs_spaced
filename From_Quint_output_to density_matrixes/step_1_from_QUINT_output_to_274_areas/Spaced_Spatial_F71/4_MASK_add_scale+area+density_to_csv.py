...
# def add_scale_and_density_to_every_csvAAAAAAAAAAAAAAA (dict_fettinaVScsv, lista_file_csv):
#     for csv in lista_file_csv:
...
lista_file_csv = get_list_of_file_in_directory('MASK_RefAtlasRegions')
...
cartella='MASK_RefAtlas_with_density'
os.mkdir(cartella)
